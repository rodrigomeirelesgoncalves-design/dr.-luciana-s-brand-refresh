...
const BlogCtaWhatsapp = ({ phrase, whatsappText, imageIndex }: BlogCtaWhatsappProps) => {
  return (
    <div className="cta-inline flex flex-col md:flex-row items-center gap-6 md:gap-8 not-prose my-12">
      <div className="w-32 h-32 md:w-36 md:h-36 rounded-full overflow-hidden flex-shrink-0 border-3 border-accent shadow-lg ring-4 ring-accent/20">
        <img
      ...
      <div className="flex-1 text-center md:text-left">
        <p className="font-heading text-lg md:text-xl text-foreground italic mb-3 leading-relaxed">
          "{phrase}"
        </p>
        <p className="text-muted-foreground text-sm mb-1 font-semibold">
          Dra. Luciana Spinelli
        </p>
        <p className="text-muted-foreground text-xs mb-4">
          Psicóloga Clínica · CRP 18/03885 · Especialista em Narcisismo
        </p>
        <a
          href={getWhatsappLink(whatsappText)}
          target="_blank"
          rel="noopener noreferrer"
          className="cta-whatsapp inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-body text-sm tracking-wide px-6 py-3 rounded-full transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02]"
        >
